...
const myFirstArray = [13, 'IT','массив', 4, 9, true];// объявите переменную здесь
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.

const mySecondArray = [13, 'массив', true]; // объявите переменную здесь
...
const myInformation = ['Аня', 1, 'Января', 'Козерог'];
...
const shiftCountry = copyCountries.shift();
console.log(shiftCountry);
...
const sortNumbers = copyNumbers.sort(function(a,b){
    return a - b;
});
